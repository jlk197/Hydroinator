...
const ImageEntitySchema = Schema(
  name: r'ImageEntity',
...
extension ImageEntityQueryFilter
  ...
  QueryBuilder<ImageEntity, ImageEntity, QAfterFilterCondition> dateTimeEqualTo(
      DateTime? value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ImageEntity, ImageEntity, QAfterFilterCondition> dateTimeBetween(
    DateTime? lower,
    DateTime? upper, {
  ...
  QueryBuilder<ImageEntity, ImageEntity, QAfterFilterCondition> imageEqualTo(
    String value, {
  ...
  QueryBuilder<ImageEntity, ImageEntity, QAfterFilterCondition> imageLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<ImageEntity, ImageEntity, QAfterFilterCondition> imageBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<ImageEntity, ImageEntity, QAfterFilterCondition> imageStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ImageEntity, ImageEntity, QAfterFilterCondition> imageEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ImageEntity, ImageEntity, QAfterFilterCondition> imageContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ImageEntity, ImageEntity, QAfterFilterCondition> imageMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
